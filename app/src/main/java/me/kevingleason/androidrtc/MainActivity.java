...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] permissions = {Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO, Manifest.permission.ACCESS_NETWORK_STATE, Manifest.permission.WAKE_LOCK};

        Nammu.askForPermission(this, permissions, permissionsCallback);
    ...
    final PermissionCallback permissionsCallback = new PermissionCallback() {
        @Override
